...
def create_ifc_file(width, height, depth, file_path):
    ...
    project = model.createIfcProject(ifcopenshell.guid.new())
    ...
    wall = model.create_entity('IfcWall', GlobalId=ifcopenshell.guid.new(), Name='Wall Name') 
...
def export_ifc():
    ...
    create_ifc_file(width, height, depth, temp_file.name)
