(function() {
    ...
    // FUNCTION THAT ADDS THE FILTESED RESULT TO A GRID 
    ...
    //FUNCTION TO SHOW THE DETAILS of a selected OBJECT
    function showDetailModal(imageUrl, details) {
        ...
        details.forEach(function(detail) {
            //TO DO Organize how we illustrate the data - here or seomewhere else WHERE SHOULD I DO IT???
            //BASIC INFO: 'Name', 'NameDE', 'Category', 'NumberCode', 'Variation', 'Width',  'Height',  'Placement', 'Finishing',
            //PROPERTIES 'LoadBearing',  'StiffeningFunction',  'Prefabrication', , 'Water',  'Heating', 'Ventilation','Electricity','FireRequirementsDE','FireRating','AcoustingRating','ThermalTransmittance',
            //INHOUSE INFO:'Version','Reasoning',
            
            //create VARIABLES and assign data from .csvof the selected object
            //TODO change the variable p to selectedPart
            //console.log("These are the details of the objecta: ", detail)
            var p = document.createElement('p');
            p.textContent = `${detail.header}: ${detail.value}`;
            modalDetails.appendChild(p);
            
            //i.e. object dimensions, element properties etc 
        ...
        document.getElementById('exportButton').addEventListener('click', function() {
            ...
            // Get the current properties dimensions of the selected object
            // Some prints for sanity check
            console.log("the name of the selected item is:" +objectName);
            console.log("the product variaton is:"+objectVariation);
            console.log("the code of the selected item is:" +objectCode);
            console.log("the thickness of the selected item is:" +objectThickness);
            console.log("is the object external?:" +objectIsExternal);
            console.log("the element has a striffening function :" + objectIsStiffening);
            console.log("the element's fire Rating is :" + objectIsFireRated);
    ...
    //document.getElementById('exportDetailedGeoButton').addEventListener('click', function() {
         ///TO DO - I want to call a js script here that loads a geometry 
    //});
    ...
    function createBoundingBox(objectCategory,objectWidth, objectHeight, objectThickness){
        ...
        switch (objectCategory) {
            ...
            case 'column':
                ...
                console.log("Got in the column category and the dimensions of selected item is:" +width+','+height +','+depth);
                break;
            case 'beam':
                width = objectWidth*unitCnversionFactor;   
                height =  objectThickness*unitCnversionFactor// This should be value coming from the CSV
                depth = objectHeight*unitCnversionFactor; 
                console.log("Got in the beam category and the dimensions of selected item is:" +width+','+height +','+depth);
                break;
            default:
                width = objectWidth*unitCnversionFactor;
                height = objectHeight*unitCnversionFactor;
                depth = objectThickness*unitCnversionFactor;
                console.log("Got in the OTHER category (3d modules?) and the dimensions of selected item is:" +width+','+height +','+depth);
        }
    ...
    function showBuildingElement(objectName,objectCategory,objectVariation){
